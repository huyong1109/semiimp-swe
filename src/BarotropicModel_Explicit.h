#ifndef __BarotropicModel_Explicit__
#define __BarotropicModel_Explicit__
 ...
 */
class BarotropicModel_Explicit : public BarotropicModel {
protected:
    ...
    TimeLevelIndex oldTimeIdx, newTimeIdx;
public:
    BarotropicModel_Explicit();
    virtual ~BarotropicModel_Explicit ();
